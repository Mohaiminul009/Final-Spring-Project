...
DROP TABLE IF EXISTS `class_prices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `class_prices` (
  `class_price_id` int NOT NULL AUTO_INCREMENT,
  `class_price` int NOT NULL,
  `class_id` int NOT NULL,
  `class_price_vat` int NOT NULL,
  `class_price_discount` int NOT NULL,
  PRIMARY KEY (`class_price_id`),
  KEY `fk_crid3_idx` (`class_id`),
  CONSTRAINT `fk_crid3` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `class_prices` WRITE;
/*!40000 ALTER TABLE `class_prices` DISABLE KEYS */;
/*!40000 ALTER TABLE `class_prices` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `course` (
  ...
  `course_access` varchar(255) DEFAULT NULL,
  `course_article` varchar(255) DEFAULT NULL,
  `course_cat_id` int DEFAULT NULL,
  `course_curriculum` longtext,
  `course_description` longtext,
  `course_duration` varchar(255) DEFAULT NULL,
  `course_name` varchar(255) DEFAULT NULL,
  `course_resource` varchar(255) DEFAULT NULL,
  `course_upload_date` varchar(255) DEFAULT NULL,
  `instructor_id` int DEFAULT NULL,
  `course_cat_name` varchar(45) DEFAULT NULL,
...
CREATE TABLE `course_prices` (
  ...
  `course_id` int NOT NULL,
  `course_price_vat` int NOT NULL,
  `course_price_discount` int NOT NULL,
  PRIMARY KEY (`course_price_id`),
  KEY `fk_ccid2_idx` (`course_id`),
  CONSTRAINT `fk_ccid2` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `invoice` (
  ...
  KEY `fk_cpid_idx` (`class_price_id`),
  KEY `fk_cpid_idx1` (`course_price_id`),
  CONSTRAINT `fk_cpid` FOREIGN KEY (`course_price_id`) REFERENCES `course_prices` (`course_price_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_crpid` FOREIGN KEY (`class_price_id`) REFERENCES `class_prices` (`class_price_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2023-01-30  1:17:18
